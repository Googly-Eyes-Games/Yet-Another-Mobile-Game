...
namespace cratesmith.assetui
{
	...
	{
		[MenuItem("Assets/Delete Sub Asset(s)")]
		...
		[MenuItem("Assets/Delete Sub Asset(s)", validate = true)]
		static bool DeleteSubAssetValidate() => Selection.objects.Any(CanEditSubAsset);
		
		[MenuItem("Assets/Rename Sub Asset...")]
		...
		[MenuItem("Assets/Rename Sub Asset...", validate = true)]
